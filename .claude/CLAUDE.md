...
/optimize → orchestrator-agent (main thread, settings.json)
  ...
  │   │  Reuses implement-agent + pr-review-toolkit:code-reviewer + pr-review-toolkit:silent-failure-hunter.

...
### Metric Comparison
```
<output of ${CLAUDE_PLUGIN_ROOT}/scripts/plot_results.py comparison chart>
```

### Improvement Timeline
```
<output of ${CLAUDE_PLUGIN_ROOT}/scripts/plot_results.py timeline chart>
```

### HP Sensitivity
```
<output of ${CLAUDE_PLUGIN_ROOT}/scripts/plot_results.py sensitivity chart for highest-impact HP>
```
...
- **Execution host:** [Include if `user_choices.remote` was set] Training ran on <remote.host>, not the machine that produced this report. Results are specific to that hardware.
